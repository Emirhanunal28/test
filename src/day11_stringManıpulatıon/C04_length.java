...
public class C04_length {
    public static void main(String[] args) {
        ...
        //System.out.println(str2.length());// çalıştırdığımzda hata verir

        String str3;
        //System.out.println(str3);
        //str3 ile str2 ye deger atanmamıstır
        // str2 null poınter ile işaretlendıgınden java durumun kontrol altında
        // olduğunu bilir

        // ve geriye kalan kodun calismasina engel olmaz
        // ancak str3' e bir deger atamasi olmayinca java altini kirmizi cizer
        // ve bu durum duzeltilinceye kadar kodun geriye kalaninin calismasinada
        // izin vermez
