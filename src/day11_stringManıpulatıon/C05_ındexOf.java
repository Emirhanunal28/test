...
public class C05_ındexOf {
    public static void main(String[] args) {
        ...
        // istersek bir harf ya da metin olarak verdigimiz String'in indexini
        // dondurur
        ...
        System.out.println(str1.indexOf("b"));// 5 buldugu ilk dogru eslesmenin
        // indexini dondurur


        System.out.println(str1.indexOf('b',5));
        // bu method'da java aramaya fromIndex olarak yazdigimiz index'den
        // baslar
        //(inclusive)
        ...
        System.out.println(str1.indexOf("y"));// y yok demesi lazim ama return
        // type'i index
